...
export function CreateButton({
  ...
  return (
    <button
      {...props}
      className="text-gray-100 font-bold shadow-md bg-blue-dark hover:bg-blue transition-colors rounded gap-2 w-24 h-14 flex justify-center items-center"
    >
      <span>Criar</span>
